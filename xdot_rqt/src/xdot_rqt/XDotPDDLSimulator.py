...
class PlanViewWidget(QWidget):
    ...
    def updateUI(self, state_info):
        ...
        if self.active_state_name == "GOAL":
            if self.current_run < self.num_runs :
                ...
                self.run_history.append("Run: " + str(self.current_run+1) +" Length: " + str(self.length[self.current_run]) + " Success")
                self.current_run+=1
        ...
        if self.active_state_name == "X" or state_info.action_name == "":
            if self.current_run < self.num_runs :
                #item = QListWidgetItem(self.runView)
                self.run_history.append("Run: " + str(self.current_run+1) +" Length: " + str(self.length[self.current_run])+ " Fail :" + self.lastoutcome)
                self.current_run+=1
                self.runUI.setText(str(self.current_run))
                self.length.append(1);
    ...
    def send_feedback(self):
         ...
         action_params = self.active_action_name.split("_") 
         if len(self.active_action_outcomes)==1:
             msg.outcome=self.active_action_outcomes[0]
         elif action_params[0] == "move-with-w0-to":
            if rand > 4000 :
                msg.outcome=self.active_action_outcomes[0]
            elif rand > 9 :
                ...
                msg.outcome="2"
         elif action_params[0] == "move-with-w1-to":
            if rand > 4500 :
                msg.outcome=self.active_action_outcomes[0]
            elif rand > 10 :
                msg.outcome=self.active_action_outcomes[1]
                ...
                msg.outcome="2"
         elif action_params[0] == "move-with-w2-to":
            if rand > 4700 :
                msg.outcome=self.active_action_outcomes[0]
            elif rand > 12 :
                msg.outcome=self.active_action_outcomes[1]
                ...
                msg.outcome="2"
         elif action_params[0] == "move-with-w3-to":
            if rand > 5000 :
                msg.outcome=self.active_action_outcomes[0]
            elif rand > 15 :
                msg.outcome=self.active_action_outcomes[1]
                ...
                msg.outcome="2"
         elif action_params[0] == "move-with-w4-to":
            if rand > 5300 :
                msg.outcome=self.active_action_outcomes[0]
            elif rand > 19 :
                msg.outcome=self.active_action_outcomes[1]
                ...
                msg.outcome="2"
         elif action_params[0] == "move-with-w5-to":
            if rand > 5300 :
                msg.outcome=self.active_action_outcomes[0]
            elif rand > 24 :
                msg.outcome=self.active_action_outcomes[1]
                ...
                msg.outcome="2"
         self.lastoutcome=msg.outcome
         rospy.loginfo("pufff2")    
         msg.succeed=True
         self.waitforSubs(pub)
         pub.publish(msg)
