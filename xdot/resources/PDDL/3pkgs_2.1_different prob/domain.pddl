...
(:action load-package
 ...
 :precondition (and (pkgat ?pkg ?wp) (quadat ?wp)(grounded)(weightquad ?w1)(weightpkg ?pkg ?w2)(addweight ?w1 ?w2 ?w3))
...
(:action move-with-w0-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)
		(probabilistic 0.6 (and(quadfuel ?fuel2)(not(quadfuel ?fuel3)))
		               0.399 (and(quadfuel ?fuel1)(not(quadfuel ?fuel3)))
                               0.001 (not(operating))
			       )))
(:action move-with-w1-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)
		(probabilistic 0.55 (and(quadfuel ?fuel2)(not(quadfuel ?fuel3)))
		               0.4489 (and(quadfuel ?fuel1)(not(quadfuel ?fuel3)))
                               0.0011 (not(operating))
			       )))
(:action move-with-w2-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)
		(probabilistic 0.53 (and(quadfuel ?fuel2)(not(quadfuel ?fuel3)))
		               0.4687 (and(quadfuel ?fuel1)(not(quadfuel ?fuel3)))
                               0.0013 (not(operating))
			       )))
(:action move-with-w3-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)
		(probabilistic 0.5 (and(quadfuel ?fuel2)(not(quadfuel ?fuel3)))
		               0.4984 (and(quadfuel ?fuel1)(not(quadfuel ?fuel3)))
                               0.0016 (not(operating))
			       )))
(:action move-with-w4-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)
		(probabilistic 0.47 (and(quadfuel ?fuel2)(not(quadfuel ?fuel3)))
		               0.528 (and(quadfuel ?fuel1)(not(quadfuel ?fuel3)))
                               0.002 (not(operating))
			       )))
(:action move-with-w5-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)
		(probabilistic 0.45 (and(quadfuel ?fuel2)(not(quadfuel ?fuel3)))
		               0.5475 (and(quadfuel ?fuel1)(not(quadfuel ?fuel3)))
                               0.0025 (not(operating))
			       )))
