...
(:predicates (deliverat ?pkg - package ?wp - waypoint)
	     ...
	     (stationat ?wp - waypoint)
             ...
             (free)
             (notloaded)
             (weightmapping ?w -weightlvl)
             (weightlevel ?w - weightlvl)
...
(:action move-to-w0
 ...
 :precondition (and(quadat ?wp1)(connected ?wp1 ?wp2)(quadfuel ?fuel3)(fuelmapping ?fuel1 ?fuel2)(fuelmapping ?fuel2 ?fuel3)(onair)(weightlevel w0))
