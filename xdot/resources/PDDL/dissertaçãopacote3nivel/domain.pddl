...
(:action land
 :parameters (?fuel1 ?fuel2 ?fuel3 - fuellvl)
 :precondition (and (onair)(quadfuel ?fuel3)(fuelmapping ?fuel1 ?fuel2)(fuelmapping ?fuel2 ?fuel3)(free))
 :effect (and (not(free))(grounded) (not(onair)) (quadfuel ?fuel1)(not(quadfuel ?fuel3))))

(:action take-off
 :parameters (?fuel1 ?fuel2 ?fuel3 - fuellvl)
 :precondition (and (grounded)(quadfuel ?fuel3)(fuelmapping ?fuel1 ?fuel2)(fuelmapping ?fuel2 ?fuel3)(free))
 :effect (and (not(free))(onair) (not(grounded)) (quadfuel ?fuel1)(not(quadfuel ?fuel3))))
...
(:action move-with-w0-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel5))
		(probabilistic 0.45(quadfuel ?fuel3)
                       0.4(quadfuel ?fuel2)
                       0.15(quadfuel ?fuel1)
			       )))
(:action move-with-w1-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel5))
		(probabilistic 0.2 (quadfuel ?fuel3)
                       0.55(quadfuel ?fuel2)
                       0.25(quadfuel ?fuel1)
			       )))
(:action move-with-w2-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel6))
		(probabilistic  0.35(quadfuel ?fuel3)
                       0.5(quadfuel ?fuel2)
                       0.15(quadfuel ?fuel1)
			       )))
