...
(:action move-with-w1-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.49 (quadfuel ?fuel2)
		               0.51 (quadfuel ?fuel1)
			       )))
(:action move-with-w2-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.42 (quadfuel ?fuel2)
		               0.58 (quadfuel ?fuel1)
			       )))
(:action move-with-w3-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.33 (quadfuel ?fuel2)
		               0.67 (quadfuel ?fuel1)
			       )))
(:action move-with-w4-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.23 (quadfuel ?fuel2)
		               0.77 (quadfuel ?fuel1)
			       )))
(:action move-with-w5-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.12 (quadfuel ?fuel2)
		               0.88 (quadfuel ?fuel1)
			       )))
(:action recover
 :parameters ()
