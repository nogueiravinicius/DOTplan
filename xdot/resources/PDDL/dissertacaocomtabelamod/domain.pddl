...
(:action drop-package
 ...
 :precondition (and (pkgat ?pkg ?wp1) (quadat ?wp2)(inquad ?pkg)(grounded)(weightquad ?w3)(weightpkg ?pkg ?w2)(addweight ?w1 ?w2 ?w3))
...
(:action move-with-w0-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel5))
		(probabilistic 0.54(quadfuel ?fuel3)
                       0.99(quadfuel ?fuel2)
                       0.33(quadfuel ?fuel1)
			       )))
(:action move-with-w1-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel5))
		(probabilistic 0.1 (quadfuel ?fuel3)
                       0.98(quadfuel ?fuel2)
                       0.92(quadfuel ?fuel1)
			       )))
(:action move-with-w2-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel6))
		(probabilistic  0.36(quadfuel ?fuel3)
                       0.97(quadfuel ?fuel2)
                       0.16(quadfuel ?fuel1)
			       )))
(:action move-with-w3-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel6))
		(probabilistic 0.12(quadfuel ?fuel3)
                       0.96(quadfuel ?fuel2)
                       0.46(quadfuel ?fuel1)
			       )))
(:action move-with-w4-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel6))
		(probabilistic 0.66 (quadfuel ?fuel3)
                       0.95(quadfuel ?fuel2)
                       0.08(quadfuel ?fuel1)
			       )))
(:action move-with-w5-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel7))
		(probabilistic  0.24(quadfuel ?fuel3)
                       0.94(quadfuel ?fuel2)
                       0.24(quadfuel ?fuel1)
			       )))
