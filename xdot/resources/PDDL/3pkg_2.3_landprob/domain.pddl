...
(:action move-with-w0-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.399 (quadfuel ?fuel2)
		               0.6 (quadfuel ?fuel1)
...
(:action move-with-w1-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.3889 (quadfuel ?fuel2)
		               0.61 (quadfuel ?fuel1)
...
(:action move-with-w2-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.3687 (quadfuel ?fuel2)
		               0.63 (quadfuel ?fuel1)
...
(:action move-with-w3-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.3484 (quadfuel ?fuel2)
		               0.65 (quadfuel ?fuel1)
...
(:action move-with-w4-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.328 (quadfuel ?fuel2)
		               0.67 (quadfuel ?fuel1)
...
(:action move-with-w5-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.2975 (quadfuel ?fuel2)
		               0.70 (quadfuel ?fuel1)
