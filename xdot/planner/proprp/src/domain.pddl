...
(:action move-with-w0-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.8 (quadfuel ?fuel2)
		               0.2 (quadfuel ?fuel1)
			       )))
(:action move-with-w1-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.75 (quadfuel ?fuel2)
		               0.25 (quadfuel ?fuel1)
			       )))
(:action move-with-w2-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.73 (quadfuel ?fuel2)
		               0.27 (quadfuel ?fuel1)
			       )))
(:action move-with-w3-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.7 (quadfuel ?fuel2)
		               0.3 (quadfuel ?fuel1)
			       )))
(:action move-with-w4-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.67 (quadfuel ?fuel2)
		               0.33 (quadfuel ?fuel1)
			       )))
(:action move-with-w5-to
 ...
 :effect (and (free)(not (quadat ?wp1)) (quadat ?wp2)(not(quadfuel ?fuel3))
		(probabilistic 0.65 (quadfuel ?fuel2)
		               0.35 (quadfuel ?fuel1)
			       )))
(:action recover
 :parameters ()
